                  ...
                  <div class="card p-3">
                     <div class="card-body">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" placeholder="Enter Email" name="mail">
                                 </div>
                              </div>
                           ...
                           <button type="submit" class="btn btn-primary btn-block mt-2" value="" name="submit">Create Account</button>
