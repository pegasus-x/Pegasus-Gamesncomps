                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown">
                           ...
                           <img src="assets/images/Flag/Flag_of_India.svg.webp" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                           <span class="bg-primary"></span>
                           </a>
                        ...
                        <li class="nav-item nav-icon dropdown">
                           ...
                           <span class="mb-0 ml-2 user-name">Pegasus X</span>
                           </a>
                           <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              ...
                              <li class="dropdown-item  d-flex svg-icon border-top">
                                 ...
                                 <a href="action/index_manage.php?submit=logout">Logout</a>
                              </li>
                           </ul>
                        </li>
                     </ul>
