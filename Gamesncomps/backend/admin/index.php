               ...
               <div class="col-md-5">
                  <div class="card p-3">
                     <div class="card-body">
                        ...
                        <form action="action/index_manage.php" method="POST" enctype="multipart/form-data">
                             <?php include 'msg.php'?>
                           <div class="row">
                              <div class="col-lg-12">
                           ...
                           <button type="submit" class="btn btn-primary btn-block mt-2" value="submit_form" name="submit">Log In</button>
                           <div class="col-lg-12 mt-3">
                              <p class="mb-0 text-center">Don't have an account? <a href="signup.php">Sign Up</a></p>
                           </div>
                        </form>
                     </div>
                  </div>
